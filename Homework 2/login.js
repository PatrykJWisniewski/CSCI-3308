function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        // the text entered in password equals the text in confirm password
        ...
        //This need to be here as well because if not you can still click the submit button if you change the orginal password input even tho they could no longer match
